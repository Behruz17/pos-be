...
```
**Ошибки:**
- `400 Bad Request`: Если не указано поле `full_name` или `store_id`, или если магазин с указанным ID не найден
...
**Примеры использования:**
- `/api/sales` - все продажи
- `/api/sales?year=2023` - продажи за 2023 год
- `/api/sales?month=12&year=2023` - продажи за декабрь 2023 года
- `/api/sales?store_id=1` - продажи для магазина с ID 1
- `/api/sales?month=12&year=2023&store_id=1` - продажи за декабрь 2023 года для магазина с ID 1
**Ответ:**
```json
[
  {
